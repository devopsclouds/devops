...
for results in startlimit:
    ...
    pull_request_url=url+repo+pull_requests+state+branches+results
    pull_request_url_file=url+repo+pull_requests
    ...
    ### take a json object and returns a string
